# PDL: Flash ECC error injection

This code example demonstrates the usage of the error correcting code (ECC) error injection feature to test the functionality of flash ECC.

[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce240950-flash-ecc-injection)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[mtb-example-ce240950-flash-ecc-injection](https://github.com/Infineon/mtb-example-ce240950-flash-ecc-injection)" application with the desired name "FlashEccInjection" configured for the *KIT_T2G_C-2D-6M_LITE* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_T2G_C-2D-6M_LITE --app-id mtb-example-ce240950-flash-ecc-injection --user-app-name FlashEccInjection --target-dir "C:/mtb_projects"
   ```
...
4. After programming, the application starts automatically. Confirm that "Flash ECC Error Injection Code Example" is displayed on the UART terminal.

   **Figure 1. Terminal output on program startup**

   <img src="images/terminal-output.png" width="800" height="600" />
...
Resources  | Links
-----------|----------------------------------
Application notes  | [AN235305](https://www.infineon.com/assets/row/public/documents/10/42/infineon-an235305-getting-started-with-traveo-t2g-family-mcus-in-modustoolbox-applicationnotes-en.pdf) – Getting started with TRAVEO&trade; T2G family MCUs in ModusToolbox&trade; <br> [AN220242](https://www.infineon.com/row/public/documents/10/42/infineon-an220242---flash-accessing-procedure-for-traveo-t2g-family-applicationnotes-en.pdf) – Flash accessing procedure for TRAVEO&trade; T2G family <br> [AN219842](https://www.infineon.com/row/public/documents/10/42/infineon-an219842---how-to-use-interrupt-in-traveo-tm-t2g-applicationnotes-en.pdf) – How to use interrupt in TRAVEO&trade; T2G
...
Document title: *CE240950 – PDL: Flash ECC error injection* 
